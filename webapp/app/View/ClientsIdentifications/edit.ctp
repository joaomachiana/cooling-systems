<div class="row-fluid">
	<div class="span9">
		<?php echo $this->BootstrapForm->create('ClientsIdentificationType', array('class' => 'form-horizontal'));?>
			<fieldset>
				<legend><?php echo __('Edit %s', __('Clients Identification Type')); ?></legend>
				<?php
	...
	<div class="span3">
		...
		<ul class="nav nav-list">
			...
			<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ClientsIdentificationType.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ClientsIdentificationType.id'))); ?></li>
