<div class="row-fluid">
	<div class="span9">
		<h2><?php echo __('List %s', __('Clients'));?></h2>
		...
		<table class="table">
			<tr>
				...
				<th><?php echo $this->BootstrapPaginator->sort('client_type');?></th>
		...
		<?php foreach ($clients as $client): ?>
			<tr>
				...
				<td><?php echo h($client['Client']['particular_id']); ?>&nbsp;</td>
				<td><?php echo h($client['Client']['corporate_id']); ?>&nbsp;</td>
