<div class="row-fluid">
	<div class="span9">
		<?php echo $this->BootstrapForm->create('PersonalInfo', array('class' => 'form-horizontal'));?>
			<fieldset>
				<legend><?php echo __('Edit %s', __('Personal Info')); ?></legend>
				<?php
				...
				echo $this->BootstrapForm->hidden('personal_info_id');
				?>
	...
	<div class="span3">
		...
		<ul class="nav nav-list">
			...
			<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PersonalInfo.personal_info_id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PersonalInfo.personal_info_id'))); ?></li>
